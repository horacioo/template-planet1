    ...
    <footer>
        <section>
            <h2>Planet1</h2>
            <p>
                A planet1 é uma agencia de criação de sites que atua junto a nossos cliente com eficiencia na criação de sites profissionais , oferecendo sites de qualidade,
                atendimento eficiente e hospedagem eficiente para seus clientes.
            </p>
        ...
        <section>
            ...
            <ul>
                ...
                <li>
                    <object>
                        <svg width="26" class="menuIcon"  height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_282_2)">
                                <path d="M25.2446 23.447C25.2446 24.7415 24.1953 25.7908 22.9009 25.7908H2.58838C1.29395 25.7908 0.244629 24.7415 0.244629 23.447V10.5918C0.244633 10.2364 0.325463 9.88561 0.481005 9.56605C0.636546 9.24649 0.862725 8.96649 1.14243 8.74722C2.35889 7.79366 3.36416 7.02042 9.16001 2.81407C9.98154 2.2151 11.6117 0.773836 12.7446 0.790926C13.8773 0.77364 15.5081 2.21534 16.3292 2.81402C22.1245 7.01993 23.1312 7.79425 24.3468 8.74722C24.6265 8.96649 24.8527 9.24649 25.0083 9.56605C25.1638 9.88561 25.2446 10.2364 25.2446 10.5918V23.447ZM22.0383 13.8472C21.9131 13.6651 21.6623 13.6228 21.4846 13.7541C20.3691 14.5779 18.7765 15.7416 16.3292 17.5177C15.5077 18.1166 13.8776 19.5578 12.7446 19.5406C11.6113 19.5574 9.98296 18.1176 9.16001 17.5177C6.71304 15.7418 5.12026 14.578 4.00464 13.7541C3.82695 13.6228 3.57612 13.6651 3.45098 13.8472L3.00801 14.4915C2.95059 14.575 2.92786 14.6775 2.94461 14.7774C2.96137 14.8773 3.0163 14.9668 3.0978 15.027C4.21533 15.8522 5.80552 17.0138 8.23955 18.7803C9.22949 19.5021 10.9995 21.1149 12.7446 21.1032C14.489 21.115 16.2583 19.5031 17.2497 18.7803C19.6837 17.0138 21.274 15.8521 22.3914 15.027C22.4729 14.9668 22.5278 14.8773 22.5446 14.7774C22.5613 14.6775 22.5386 14.575 22.4812 14.4915L22.0383 13.8472Z" fill="black" />
                            </g>
                            <defs>
                                <clipPath id="clip0_282_2">
                                    <rect width="25" height="25" fill="white" transform="translate(0.244629 0.790771)" />
                                </clipPath>
                            </defs>
                        </svg>
                ...
                <li>
                    <object>
                        <svg width="25" class="menuIcon"  height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <object>
                        <svg width="23" class="menuIcon"  class="menuIcon"  height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <section>
            ...
            <ul>
                ...
                <!-------------------------------------------------------->
                <li><a href="#">criação de Sistemas</a></li>
                <!-------------------------------------------------------->
                <li><a href="#">Lojas Virtuais</a></li>
                <!-------------------------------------------------------->
                <li><a href="#">Hospedagem</a></li>
                <!-------------------------------------------------------->
                <li><a href="#">Otimização</a></li>
                <!-------------------------------------------------------->
            </ul>
        </section>
